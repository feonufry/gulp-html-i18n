(function() {
  ...
  handleUndefined = function(propName, properties, opt) {
    if (opt.failOnMissing) {
      ...
      return console.warn(gutil.colors.yellow("Warning: `" + (gutil.colors.white(propName)) + "` not found in definition file for `" + (gutil.colors.white(properties._lang_)) + "` locale."));
    }
  };
